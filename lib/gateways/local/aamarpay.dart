...
class AamarpayButton extends StatefulWidget {
  final double amount;
  const AamarpayButton({super.key, required this.amount});

  @override
  State<AamarpayButton> createState() => _AamarpayButtonState();
}

class _AamarpayButtonState extends State<AamarpayButton> {
  ...
  Widget build(BuildContext context) {
    return Aamarpay(
      ...
      customerEmail: "dv.mahbub@gmail.com",
      customerMobile: "01767646871",
      customerName: "Mahbub Al Hasan",
