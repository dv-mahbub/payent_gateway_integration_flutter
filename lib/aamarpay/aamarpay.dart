...
class CustomAamarpay extends StatefulWidget {
  ...
  CustomAamarpay({super.key,
    ...
    @Deprecated('Use status function instead of paymentStatus')
    this.paymentStatus,
    this.isLoading,
    required this.child,
    this.returnUrl,
  ...
  _CustomAamarpayState createState() => _CustomAamarpayState();
}

class _CustomAamarpayState<T> extends State<CustomAamarpay> {
